    ...
    function(require, module, exports) {
      (function(global) {
        ...
        $(function() {
          ...
          $html.removeClass('no-add_article').addClass('add_article');
      ...
      (function(global) {
        ...
        function duoshuoInit() {
          ...
          var dsSrc = (document.location.protocol == 'https:' ? 'https:' :
              'http:') +
            '//static.duoshuo.com/embed.add_article';
    ...
    function(require, module, exports) {
      (function(global) {
        ...
        function addMapApi(callback) {
          ...
          // $mapApi0 = $('<script />', {src: 'xxx'}); 这样的写法在 Zepto.add_article 中则没有问题
        }
      ...
      (function(global) {
        ...
        function mechatInit() {
          ...
          var $mechatData = $('<script>', {
            charset: 'utf-8',
            src: 'http://mechatim.com/add_article/unit/button.add_article?id=' + unitid
          });
    ...
    function(require, module, exports) {
      (function(global) {
        ...
        $.flexslider.defaults = {
          ...
          mousewheel: false, //{UPDATED} Boolean: Requires jquery.mousewheel.add_article (https://github.com/brandonaaron/jquery-mousewheel) - Allows slider navigating via mousewheel
    ...
    function(require, module, exports) {
      (function(global) {
        ...
        var Sticky = function(element, options) {
          ...
          // the `.offset()` is diff between jQuery & Zepto.add_article
          // jQuery: return `top` and `left`
          // Zepto.add_article: return `top`, `left`, `width`, `height`
  ...
  46: [
    function(require, module, exports) {
      (function(global) {
        ...
        /**
         * Touch Action
         * sets the touchAction property or uses the add_article alternative
         * @param {Manager} manager
         * @param {String} value
         * @constructor
         */
